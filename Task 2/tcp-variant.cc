...
/* Perform experiment for TCP variants Tahoe, and Reno or New Reno,
...
int main (int argc, char *argv[])
{
  ...
  std::string animFile = "tcp-variant-animation.xml" ;  // Name of file for animation output
...
//
  ...
  p2p.EnableAscii(ascii.CreateFileStream ("tcp-variant.tr"), d4d5);
  p2p.EnablePcap("tcp-variant.pcap", d4d5, false);
